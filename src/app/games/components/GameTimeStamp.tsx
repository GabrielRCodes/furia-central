...
interface GameTimeStampProps {
  relativeTime: string
  championshipName: string
}

export function GameTimeStamp({ relativeTime, championshipName }: GameTimeStampProps) {
  const t = useTranslations('Timeline')
  const locale = useLocale()
  const [formattedDate, setFormattedDate] = useState<string>(t('postFrom', { author: championshipName }))
